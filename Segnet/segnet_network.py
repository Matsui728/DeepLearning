...
class SegNet(chainer.Chain):
    def __init__(self, in_channel=3, out_channel=10,  c1=64, c2=64, c3=64,
                 c4=64, c5=64, f1=256, f2=512,
                 filter_size1=3, filter_size2=3, filter_size3=3):
        super(SegNet, self).__init__(
            # Convolution Parts
            conv1_1=L.Convolution2D(in_channel, c1, filter_size1),
            conv1_2=L.Convolution2D(c1, c1, filter_size2),
            bnorm1_1=L.BatchNormalization(c1, initial_beta=0.001),
            bnorm1_2=L.BatchNormalization(c1, initial_beta=0.001),

            conv2_1=L.Convolution2D(c1, c2, filter_size3),
            conv2_2=L.Convolution2D(c2, c2, filter_size1),
            bnorm2_1=L.BatchNormalization(c2, initial_beta=0.001),
            bnorm2_2=L.BatchNormalization(c2, initial_beta=0.001),

            conv3_1=L.Convolution2D(c2, c3, filter_size1),
            conv3_2=L.Convolution2D(c3, c3, filter_size1),
            conv3_3=L.Convolution2D(c3, c3, filter_size1),
            ...
            conv4_1=L.Convolution2D(c3, c4, filter_size1),
            conv4_2=L.Convolution2D(c4, c4, filter_size1),
            conv4_3=L.Convolution2D(c4, c4, filter_size1),
            ...
            conv5_1=L.Convolution2D(c4, c5, filter_size1),
            conv5_2=L.Convolution2D(c5, c5, filter_size1),
            conv5_3=L.Convolution2D(c5, c5, filter_size1),
            ...
            # Deconvolution Parts
            dconv5_1=L.Deconvolution2D(c5, c5, filter_size1),
            dconv5_2=L.Deconvolution2D(c5, c5, filter_size1),
            dconv5_3=L.Deconvolution2D(c5, c5, filter_size1),
            ...
            dconv4_1=L.Deconvolution2D(c5, c4, filter_size1),
            dconv4_2=L.Deconvolution2D(c4, c4, filter_size1),
            dconv4_3=L.Deconvolution2D(c4, c4, filter_size1),
            ...
            dconv3_1=L.Deconvolution2D(c4, c3, filter_size1),
            dconv3_2=L.Deconvolution2D(c3, c3, filter_size1),
            dconv3_3=L.Deconvolution2D(c3, c3, filter_size1),
            ...
            dconv2_1=L.Deconvolution2D(c3, c2, filter_size1),
            dconv2_2=L.Deconvolution2D(c2, c2, filter_size1),
            bnorm9_1=L.BatchNormalization(c2, initial_beta=0.001),
            bnorm9_2=L.BatchNormalization(c2, initial_beta=0.001),

            dconv1_1=L.Deconvolution2D(c2, out_channel, filter_size1),
            dconv1_2=L.Deconvolution2D(out_channel, out_channel, filter_size1),
    ...
    def __call__(self, x):
        ...
        h = F.relu(self.bnorm10_2(self.dconv2_2(x)))
        y = F.unpooling_2d(h, 2, outsize=outsize1)
        return y
